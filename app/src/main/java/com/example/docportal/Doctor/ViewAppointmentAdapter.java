...
public class ViewAppointmentAdapter extends FirestoreRecyclerAdapter<Appointment, ViewAppointmentAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView appointment_patient_description;
        private final TextView severityD;
        ...
        private final TextView symptomDetails;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            symptomDetails = itemView.findViewById(R.id.symptomsD);
            symptomTextView = itemView.findViewById(R.id.symptomsA);
            severityD = itemView.findViewById(R.id.severityD);
            disease_name = itemView.findViewById(R.id.disease_name);
            appointment_patient_description = itemView.findViewById(R.id.appointment_patient_description);
        }

        public void bind(Appointment appointment) {
            Map<String, Object> symptomDetail = (Map<String, Object>) appointment.getSymptom_details();
            Map<String, Object> symptomSeverity = (Map<String, Object>) appointment.getSymptom_Severity();
            ...
            if (symptomSeverity != null) {
                if (!symptomSeverity.isEmpty() && !symptomDetail.isEmpty()) {
                    ...
                    for (Map.Entry<String, Object> entry : sortedSymptomDetail.entrySet()) {
                        ...
                        symptomDetails.setText(symptomDetailsBuilder2.toString());
                    }
                    ...
                    for (Map.Entry<String, Object> entry : sortedSymptomSeverity.entrySet()) {
                        ...
                        symptomTextView.setText(symptomDetailsBuilder.toString());
                        severityD.setText(severityDetailsBuilder.toString());
                    }
                }
                ...
                symptomDetails.setText("No symptom details found");
            }
...
//            symptomTextView.setText(symptomDetailsBuilder.toString());
            ...
            disease_name.setText(appointment.getDisease_name());
            appointment_patient_description.setText(appointment.getAdditional_Description());
