...
public class BanksAdapter extends RecyclerView.Adapter<BanksAdapter.ViewHolder> implements Filterable {
    ...
    public BanksAdapter(List<String> fetched_lab_names, List<String> fetch_lab_regions, List<String> fetch_lab_time, List<String> fetch_labs_latitude,List<String> fetch_labs_longitude,List<Integer> fetch_lab_logos)  {
    ...
    @Override
    public BanksAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(BanksAdapter.ViewHolder viewHolder, final int position) {
        ...
        viewHolder.getLab_services().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    context = v.getContext();
                    Intent options_intent = new Intent(context,bloodBankOptions.class);
